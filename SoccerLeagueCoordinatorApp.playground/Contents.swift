...
let kimmyStein: [String : Any] = ["name": "Kimmy Stein", "height": 41, "experienced": false, "guardians": "Bill and Hillary Stein"]
...
let suzaneGreenburg: [String : Any] = ["name": "Suzane Greenburg", "height": 44, "experienced": true, "guardians": "Henrietta Dumas"]
